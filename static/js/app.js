...
var author$project$Page$Dashboard$route = 'dashboard';
var author$project$Page$Proof$route = 'proof-of-running-code';
var author$project$Router$CreateProject = {$: 'CreateProject'};
var author$project$Router$Dashboard = {$: 'Dashboard'};
var author$project$Router$Home = {$: 'Home'};
var author$project$Router$Proof = {$: 'Proof'};
...
var author$project$Router$route = elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			...
			author$project$Router$Proof,
			elm$url$Url$Parser$s(author$project$Page$Proof$route)),
			A2(
			elm$url$Url$Parser$map,
			author$project$Router$Dashboard,
			elm$url$Url$Parser$s(author$project$Page$Dashboard$route)),
			A2(
			elm$url$Url$Parser$map,
			author$project$Router$CreateProject,
			A2(
...
var author$project$Router$toRoute = function (urlString) {
...
var author$project$Main$init = F3(
	function (_n0, url, navKey) {
		return _Utils_Tuple2(
			{
				key: navKey,
				page: author$project$Router$toRoute(
...
var author$project$Main$SessionMsg = function (a) {
	return {$: 'SessionMsg', a: a};
};
var elm$json$Json$Decode$value = _Json_decodeValue;
var author$project$Port$Blockstack$authenticated = _Platform_incomingPort('authenticated', elm$json$Json$Decode$value);
var author$project$Session$SessionChanged = function (a) {
	return {$: 'SessionChanged', a: a};
};
var author$project$Session$Anonymous = {$: 'Anonymous'};
var author$project$Session$UserData = function (username) {
	return {username: username};
};
var elm$json$Json$Decode$field = _Json_decodeField;
var elm$json$Json$Decode$map = _Json_map1;
var elm$json$Json$Decode$string = _Json_decodeString;
var author$project$Session$userDataDecoder = function () {
	var usernameData = A2(elm$json$Json$Decode$field, 'username', elm$json$Json$Decode$string);
	return A2(elm$json$Json$Decode$map, author$project$Session$UserData, usernameData);
}();
var elm$json$Json$Decode$decodeValue = _Json_run;
var author$project$Session$decodeUser = function (value) {
	var decodedUserData = A2(elm$json$Json$Decode$decodeValue, author$project$Session$userDataDecoder, value);
	if (decodedUserData.$ === 'Ok') {
		var userData = decodedUserData.a;
		return _Utils_Tuple2(
			author$project$Session$LoggedIn,
			elm$core$Maybe$Just(userData));
	} else {
		var error = decodedUserData.a;
		return _Utils_Tuple2(
			author$project$Session$Anonymous,
			elm$core$Maybe$Just(
				{
					username: elm$json$Json$Decode$errorToString(error)
				}));
	}
};
var author$project$Session$subscriptions = function (user) {
	return author$project$Port$Blockstack$authenticated(
		function (value) {
			return author$project$Session$SessionChanged(
				author$project$Session$decodeUser(value));
		});
};
...
var author$project$Main$subscriptions = function (model) {
	return A2(
		...
		A2(
			elm$core$Platform$Sub$map,
			author$project$Main$SessionMsg,
			author$project$Session$subscriptions(model.user)));
};
var elm$json$Json$Encode$null = _Json_encodeNull;
var author$project$Port$Blockstack$authenticate = _Platform_outgoingPort(
	'authenticate',
	function ($) {
		return elm$json$Json$Encode$null;
	});
var author$project$Port$Blockstack$checkAuthentication = _Platform_outgoingPort(
	'checkAuthentication',
	function ($) {
		return elm$json$Json$Encode$null;
	});
var author$project$Port$Blockstack$signOut = _Platform_outgoingPort(
	'signOut',
	function ($) {
		return elm$json$Json$Encode$null;
	});
	...
	function (msg, _n0) {
		...
		switch (msg.$) {
			case 'SignIn':
				return _Utils_Tuple2(
					user,
					author$project$Port$Blockstack$authenticate(_Utils_Tuple0));
			case 'SignOut':
				return _Utils_Tuple2(
					user,
					author$project$Port$Blockstack$signOut(_Utils_Tuple0));
			case 'CheckAuthentication':
				return _Utils_Tuple2(
					user,
					author$project$Port$Blockstack$checkAuthentication(_Utils_Tuple0));
			default:
				var _n2 = msg.a;
				var session = _n2.a;
				var userData = _n2.b;
				var sessionChangedCmd = function () {
					if (session.$ === 'LoggedIn') {
						return A2(
				...
				var newUser = _Utils_Tuple2(session, userData);
				return _Utils_Tuple2(newUser, sessionChangedCmd);
		}
	});
var author$project$Main$proxyMsg = F2(
	function (msg, model) {
		if (msg.$ === 'SessionMsg') {
			var sessionMsg = msg.a;
			var _n1 = A2(
				author$project$Session$update,
				sessionMsg,
				_Utils_Tuple2(model.user, model.key));
			var sessionUser = _n1.a;
			var sessionCmds = _n1.b;
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{user: sessionUser}),
				A2(
					...
					author$project$Main$Forward,
					A2(elm$core$Platform$Cmd$map, author$project$Main$SessionMsg, sessionCmds)));
		} else {
			return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
		}
	});
...
var author$project$Main$update = F2(
	function (message, model) {
		switch (message.$) {
			case 'Forward':
				var msg = message.a;
				return A2(author$project$Main$proxyMsg, msg, model);
			case 'LinkClicked':
				var urlRequest = message.a;
				if (urlRequest.$ === 'Internal') {
					var url = urlRequest.a;
					var page = function () {
						var _n2 = A2(elm$url$Url$Parser$parse, author$project$Router$route, url);
						if (_n2.$ === 'Just') {
							var answer = _n2.a;
							return answer;
						} else {
			...
			default:
				var url = message.a;
				var _n3 = A2(elm$url$Url$Parser$parse, author$project$Router$route, url);
				if (_n3.$ === 'Just') {
					var answer = _n3.a;
					return _Utils_Tuple2(
						_Utils_update(
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{page: author$project$Router$NotFound}),
						elm$core$Platform$Cmd$none);
				}
		}
	});
var author$project$Main$CreateProjectMsg = function (a) {
	return {$: 'CreateProjectMsg', a: a};
};
...
var author$project$Main$ProofMsg = function (a) {
	return {$: 'ProofMsg', a: a};
};
var author$project$Main$currentChecksum = '123';
var author$project$Page$CreateProject$title = 'Create your new descentralized crowdfunding project - Blocos';
var elm$html$Html$section = _VirtualDom_node('section');
var author$project$Page$CreateProject$view = function (user) {
	var username = function () {
		if ((user.a.$ === 'LoggedIn') && (user.b.$ === 'Just')) {
			var _n1 = user.a;
			var userData = user.b.a;
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text('Create your new project')
					]))
			]));
};
var author$project$Page$Dashboard$title = 'Blocos app';
var author$project$Page$CreateProject$route = A2(
	elm$url$Url$Builder$absolute,
	_List_fromArray(
		['projects', 'new']),
	_List_Nil);
var author$project$Page$Dashboard$view = function (user) {
	var username = function () {
		if ((user.a.$ === 'LoggedIn') && (user.b.$ === 'Just')) {
			var _n1 = user.a;
			var userData = user.b.a;
			...
			[
				...
				_List_fromArray(
					[
						...
						elm$html$Html$Attributes$href(author$project$Page$CreateProject$route)
					]),
				_List_fromArray(
					[
...
var author$project$Page$Home$title = 'Blocos - Descentralized Crowdfunding';
var author$project$Session$SignIn = {$: 'SignIn'};
var author$project$Page$Home$view = function (user) {
	var username = function () {
		if ((user.a.$ === 'LoggedIn') && (user.b.$ === 'Just')) {
			var _n1 = user.a;
			var userData = user.b.a;
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text('Blocos is a descentralized crowdfunding platform ')
					])),
				A2(
				elm$html$Html$p,
				_List_fromArray(
				...
				_List_fromArray(
					[
						elm$html$Html$text('It\'s goal is to enable true peer-to-peer financial cooperation')
					])),
				A2(
				elm$html$Html$p,
				_List_fromArray(
				...
				_List_fromArray(
					[
						elm$html$Html$text('It allows for global transactions')
					])),
				A2(
				elm$html$Html$p,
				_List_fromArray(
				...
				_List_fromArray(
					[
						elm$html$Html$text('It\'s uncensored')
					])),
				A2(
				elm$html$Html$button,
				_List_fromArray(
					[
						...
						elm$html$Html$Events$onClick(author$project$Session$SignIn)
					]),
				_List_fromArray(
					[
						elm$html$Html$text('sign in using blockstack')
					]))
			]));
};
var author$project$Page$NotFound$title = 'Page Not Found';
...
var author$project$Page$NotFound$view = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					elm$html$Html$text(author$project$Page$NotFound$title)
				])),
			A2(
			elm$html$Html$p,
			_List_Nil,
			_List_fromArray(
				[
					elm$html$Html$text('We couldn\'t find the page you are looking for. :(')
				]))
		]));
var author$project$Page$Proof$title = 'Blocos - Proof of running code';
var elm$html$Html$i = _VirtualDom_node('i');
var elm$html$Html$strong = _VirtualDom_node('strong');
var elm$html$Html$Attributes$target = elm$html$Html$Attributes$stringProperty('target');
var author$project$Page$Proof$view = function (model) {
	return A2(
		elm$html$Html$section,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$text('Proof of running code')
							]))
					])),
				A2(
				elm$html$Html$p,
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$text('07wFbyetxuSrHYFYdF6tKVluAVE92qscSq5ZPJ19WGg=')
									]))
							]))
					])),
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								elm$html$Html$Attributes$href('https://github.com/blocosapp/blocos/releases')
							]),
						_List_fromArray(
							[
								elm$html$Html$text('check current release checksum')
							]))
					])),
				A2(
				elm$html$Html$p,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$text('Blocos aims to be a tool for allowing as much as possible true peer-to-peer crowd funding. Accomplishing such a task in a web environment is an utterly complex task, because of all the layers of abstractions involved.')
							]))
					])),
				A2(
				elm$html$Html$p,
				...
				_List_fromArray(
					[
						elm$html$Html$text('As a platform, Blocos sits on top of multiple open protocols and platforms such as '),
						A2(
						elm$html$Html$a,
						_List_fromArray(
							[
								elm$html$Html$Attributes$target('_blank'),
								elm$html$Html$Attributes$href('https://bitcoin.org')
							]),
						_List_fromArray(
							[
								elm$html$Html$text('bitcoin')
							])),
						elm$html$Html$text(' and '),
						A2(
						elm$html$Html$a,
						_List_fromArray(
							[
								elm$html$Html$Attributes$target('_blank'),
								elm$html$Html$Attributes$href('https://blockstack.com')
							]),
						_List_fromArray(
							[
								elm$html$Html$text('blockstack')
							])),
						elm$html$Html$text('. A core aspect of the openess of those protocols and of Blocos itself is that all of them are open-source. The source code used to run those applications is free for everyone to see, and hence, be sure of what is happening when you\'re running that code.'),
						elm$html$Html$text('Blocos, and other new web applications are bringing this concept to the forefront of the web environment. Blocos, as a whole is open source, and you can check it\'s code '),
						A2(
						elm$html$Html$a,
						_List_fromArray(
							[
								elm$html$Html$Attributes$target('_blank'),
								elm$html$Html$Attributes$href('https://github.com/blocosapp/blocos')
							]),
						_List_fromArray(
							[
								elm$html$Html$text('here')
							])),
						elm$html$Html$text('. But this raises a question: how do I know that the code I\'m checking is the code currently running on this webpage?')
					])),
				A2(
				elm$html$Html$p,
				_List_Nil,
				_List_fromArray(
					[
						elm$html$Html$text('Though this is a really small bit of garanteeing that you don\'t have any third-party subject interfering somehow with what you\'re doing on a website, this an essential bit of transparently sharing the code. Making sure that the shared code is the currently running one.')
					])),
				A2(
				elm$html$Html$p,
				_List_Nil,
				_List_fromArray(
					[
						elm$html$Html$text('To garantee this on Blocos, we use the integrity attribute of the code running on the application. With '),
						A2(
						elm$html$Html$a,
						_List_fromArray(
							[
				...
				_List_fromArray(
					[
						elm$html$Html$text('Current checksum is: ')
					])),
				A2(
				elm$html$Html$p,
				_List_Nil,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$text('the current release should be')
							])),
						elm$html$Html$text('.')
					]))
			]));
...
var author$project$Skeleton$footer = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					elm$html$Html$text('the code')
				]))
		]));
var author$project$Page$Home$route = '/';
var author$project$Session$SignOut = {$: 'SignOut'};
...
var author$project$Skeleton$logo = A2(
	...
	_List_fromArray(
		[
			elm$svg$Svg$Attributes$viewBox('0 0 444.193 83.177')
		]),
	_List_fromArray(
		[
			A2(
				...
				[
					...
					_List_fromArray(
						[
							...
							elm$html$Html$Attributes$href(author$project$Page$Home$route)
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('button button__link'),
							elm$html$Html$Events$onClick(author$project$Session$SignOut)
						]),
					_List_fromArray(
						[
...
var author$project$Skeleton$application = F3(
	function (toMsg, fromSession, children) {
		return A2(
			elm$html$Html$main_,
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('app dashboard')
				]),
			_List_fromArray(
				[
					author$project$Skeleton$header(fromSession),
					A2(elm$html$Html$map, toMsg, children),
					author$project$Skeleton$footer
				]));
	});
var author$project$Skeleton$content = F2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class('logo -big'),
										elm$html$Html$Attributes$href(author$project$Page$Home$route)
									]),
								_List_fromArray(
									[author$project$Skeleton$logo]))
	...
	var document = function () {
		...
		switch (_n0.$) {
			case 'Home':
				return {
					body: A2(
						author$project$Skeleton$content,
						author$project$Main$SessionMsg,
						author$project$Page$Home$view(model.user)),
					title: author$project$Page$Home$title
				};
			case 'Proof':
				return {
					body: A2(
						author$project$Skeleton$content,
						author$project$Main$ProofMsg,
						author$project$Page$Proof$view(author$project$Main$currentChecksum)),
					title: author$project$Page$Proof$title
				};
			case 'Dashboard':
				return {
					body: A3(
						author$project$Skeleton$application,
						author$project$Main$DashboardMsg,
						author$project$Main$SessionMsg,
						author$project$Page$Dashboard$view(model.user)),
					title: author$project$Page$Dashboard$title
				};
			case 'CreateProject':
				return {
					body: A3(
						author$project$Skeleton$application,
						author$project$Main$CreateProjectMsg,
						author$project$Main$SessionMsg,
						author$project$Page$CreateProject$view(model.user)),
					title: author$project$Page$CreateProject$title
				};
			default:
				return {
					body: A2(author$project$Skeleton$content, author$project$Main$NotFoundMsg, author$project$Page$NotFound$view),
					title: author$project$Page$NotFound$title
				};
		}
	}();
	return {
		body: _List_fromArray(
			[
				A2(elm$html$Html$map, author$project$Main$Forward, document.body)
			]),
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"},"Session.User":{"args":[],"type":"( Session.Session, Maybe.Maybe Session.UserData )"},"Session.UserData":{"args":[],"type":"{ username : String.String }"}},"unions":{"Main.Msg":{"args":[],"tags":{"LinkClicked":["Browser.UrlRequest"],"Forward":["Main.ProxyMsg"],"UrlChanged":["Url.Url"]}},"Main.ProxyMsg":{"args":[],"tags":{"SessionMsg":["Session.Msg"],"ProofMsg":["Page.Proof.Msg"],"DashboardMsg":["Page.Dashboard.Msg"],"CreateProjectMsg":["Page.CreateProject.Msg"],"NotFoundMsg":["Page.NotFound.Msg"]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"Page.CreateProject.Msg":{"args":[],"tags":{"Nothing":[]}},"Page.Dashboard.Msg":{"args":[],"tags":{"Nothing":[]}},"Page.NotFound.Msg":{"args":[],"tags":{"Nothing":[]}},"Page.Proof.Msg":{"args":[],"tags":{"Nothing":[]}},"Session.Msg":{"args":[],"tags":{"SignIn":[],"SignOut":[],"CheckAuthentication":[],"SessionChanged":["Session.User"]}},"Session.Session":{"args":[],"tags":{"Anonymous":[],"LoggedIn":[]}}}}})}});}(this));